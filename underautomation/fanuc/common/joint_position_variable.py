...
from UnderAutomation.Fanuc.Common import JointPositionVariable as joint_position_variable

class JointPositionVariable(JointsPosition):
	'''Represents a joint position variable parsed from a Fanuc variable file'''
	def __init__(self, group: int, position: JointsPosition, _internal = 0):
