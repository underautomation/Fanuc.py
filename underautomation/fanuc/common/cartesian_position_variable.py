...
from UnderAutomation.Fanuc.Common import CartesianPositionVariable as cartesian_position_variable
...
class CartesianPositionVariable(CartesianPosition):
	...
	def __init__(self, group: int, position: CartesianPosition, _internal = 0):
		'''Creates a Cartesian position variable from Cartesian position values and a motion group number.

		:param group: Motion group number
