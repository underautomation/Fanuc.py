...
from UnderAutomation.Fanuc.Common.Files.Variables import UserUframVariableType as user_ufram_variable_type
...
class UserUframVariableType(GenericVariableType):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, UserUframVariableType):
			NotImplemented
