...
import typing
from underautomation.fanuc.common.files.variables.interact_variable_type import InteractVariableType
from underautomation.fanuc.common.files.variables.intrac_n_variable_type import IntracNVariableType
from underautomation.fanuc.common.files.variables.intrac_d_variable_type import IntracDVariableType
from underautomation.fanuc.common.files.variables.dh_extra_variable_type import DhExtraVariableType
from underautomation.fanuc.common.files.variables.generic_variable_type import GenericVariableType
from UnderAutomation.Fanuc.Common.Files.Variables import MrrGrpVariableType as mrr_grp_variable_type
...
class MrrGrpVariableType(GenericVariableType):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, MrrGrpVariableType):
			NotImplemented
