...
import typing
from underautomation.fanuc.common.files.variables.log_alarm_variable_type import LogAlarmVariableType
from underautomation.fanuc.common.files.variables.generic_variable_type import GenericVariableType
from UnderAutomation.Fanuc.Common.Files.Variables import ErpostLogVariableType as erpost_log_variable_type
