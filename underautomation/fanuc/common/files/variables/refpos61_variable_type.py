...
from UnderAutomation.Fanuc.Common.Files.Variables import Refpos61VariableType as refpos61_variable_type

class Refpos61VariableType(GenericVariableType):
	'''Describes the Fanuc type REFPOS61_T'''
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = refpos61_variable_type()
		else:
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, Refpos61VariableType):
			NotImplemented
