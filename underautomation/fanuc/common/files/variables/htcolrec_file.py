...
import typing
from underautomation.fanuc.common.files.variables.auto_col_rec_variable_type import AutoColRecVariableType
from underautomation.fanuc.common.files.variables.generic_variable_file import GenericVariableFile
from UnderAutomation.Fanuc.Common.Files.Variables import HtcolrecFile as htcolrec_file
