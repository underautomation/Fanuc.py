...
from UnderAutomation.Fanuc.Common.Files.Variables import PrgnsPrefVariableType as prgns_pref_variable_type
...
class PrgnsPrefVariableType(GenericVariableType):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, PrgnsPrefVariableType):
			NotImplemented
