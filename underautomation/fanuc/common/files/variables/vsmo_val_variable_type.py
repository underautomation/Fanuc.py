...
import typing
from underautomation.fanuc.common.files.variables.position_variable_type import PositionVariableType
from underautomation.fanuc.common.files.variables.generic_variable_type import GenericVariableType
from UnderAutomation.Fanuc.Common.Files.Variables import VsmoValVariableType as vsmo_val_variable_type
