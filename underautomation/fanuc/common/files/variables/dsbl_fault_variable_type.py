...
from UnderAutomation.Fanuc.Common.Files.Variables import DsblFaultVariableType as dsbl_fault_variable_type
...
class DsblFaultVariableType(GenericVariableType):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, DsblFaultVariableType):
			NotImplemented
