...
import typing
from underautomation.fanuc.common.files.variables.i_generic_variable_type import IGenericVariableType
from underautomation.fanuc.common.files.variables.value_kind import ValueKind
# Circular dependencies  : GenericField
from UnderAutomation.Fanuc.Common.Files.Variables import GenericValue as generic_value
from UnderAutomation.Fanuc.Common.Files.Variables import ValueKind as value_kind
