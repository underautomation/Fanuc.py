...
from UnderAutomation.Fanuc.Common.Files.Variables import ZpCylinderVariableType as zp_cylinder_variable_type
...
class ZpCylinderVariableType(GenericVariableType):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, ZpCylinderVariableType):
			NotImplemented
