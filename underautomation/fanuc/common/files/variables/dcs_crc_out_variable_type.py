...
from UnderAutomation.Fanuc.Common.Files.Variables import DcsCrcOutVariableType as dcs_crc_out_variable_type
...
class DcsCrcOutVariableType(GenericVariableType):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, DcsCrcOutVariableType):
			NotImplemented
