...
import typing
from underautomation.fanuc.common.files.variables.irc_gnrc_variable_type import IrcGnrcVariableType
from underautomation.fanuc.common.files.variables.generic_variable_file import GenericVariableFile
from UnderAutomation.Fanuc.Common.Files.Variables import IrcStlabelFile as irc_stlabel_file
...
class IrcStlabelFile(GenericVariableFile):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, IrcStlabelFile):
			NotImplemented
