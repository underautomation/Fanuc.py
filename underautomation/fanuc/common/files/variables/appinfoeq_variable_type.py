...
from UnderAutomation.Fanuc.Common.Files.Variables import AppinfoeqVariableType as appinfoeq_variable_type
...
class AppinfoeqVariableType(GenericVariableType):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, AppinfoeqVariableType):
			NotImplemented
