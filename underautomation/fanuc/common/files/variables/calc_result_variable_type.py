...
from UnderAutomation.Fanuc.Common.Files.Variables import CalcResultVariableType as calc_result_variable_type
...
class CalcResultVariableType(GenericVariableType):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, CalcResultVariableType):
			NotImplemented
