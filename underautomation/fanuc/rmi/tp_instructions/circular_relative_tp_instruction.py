...
from UnderAutomation.Fanuc.Rmi.TpInstructions import CircularRelativeTpInstruction as circular_relative_tp_instruction
...
class CircularRelativeTpInstruction(CartesianMotionTpInstructionBase):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, CircularRelativeTpInstruction):
			NotImplemented
