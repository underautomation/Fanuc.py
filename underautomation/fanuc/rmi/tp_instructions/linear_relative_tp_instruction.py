...
from UnderAutomation.Fanuc.Rmi.TpInstructions import LinearRelativeTpInstruction as linear_relative_tp_instruction
...
class LinearRelativeTpInstruction(CartesianMotionTpInstructionBase):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, LinearRelativeTpInstruction):
			NotImplemented
