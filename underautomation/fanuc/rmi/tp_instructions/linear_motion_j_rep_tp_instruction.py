...
from UnderAutomation.Fanuc.Rmi.TpInstructions import LinearMotionJRepTpInstruction as linear_motion_j_rep_tp_instruction
...
class LinearMotionJRepTpInstruction(JRepMotionTpInstructionBase):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, LinearMotionJRepTpInstruction):
			NotImplemented
