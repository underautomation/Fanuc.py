...
from UnderAutomation.Fanuc.Rmi.TpInstructions import SplineMotionJRepTpInstruction as spline_motion_j_rep_tp_instruction
...
class SplineMotionJRepTpInstruction(JRepMotionTpInstructionBase):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, SplineMotionJRepTpInstruction):
			NotImplemented
