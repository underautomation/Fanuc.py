...
from UnderAutomation.Fanuc.Rmi.TpInstructions import JointRelativeTpInstruction as joint_relative_tp_instruction
...
class JointRelativeTpInstruction(CartesianMotionTpInstructionBase):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, JointRelativeTpInstruction):
			NotImplemented
