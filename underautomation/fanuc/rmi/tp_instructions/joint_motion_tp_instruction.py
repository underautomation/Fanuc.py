...
from UnderAutomation.Fanuc.Rmi.TpInstructions import JointMotionTpInstruction as joint_motion_tp_instruction
...
class JointMotionTpInstruction(CartesianMotionTpInstructionBase):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, JointMotionTpInstruction):
			NotImplemented
