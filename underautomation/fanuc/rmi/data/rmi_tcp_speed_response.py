...
from UnderAutomation.Fanuc.Rmi.Data import RmiTcpSpeedResponse as rmi_tcp_speed_response

class RmiTcpSpeedResponse(RmiTimedResponse):
	'''Result of reading TCP speed.'''
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = rmi_tcp_speed_response()
		else:
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, RmiTcpSpeedResponse):
			NotImplemented
