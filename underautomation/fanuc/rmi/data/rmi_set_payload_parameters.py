...
class RmiSetPayloadParameters:
	...
	@property
	def inertia_xkgm2(self) -> float | None:
	...
	def inertia_xkgm2(self, value: float | None):
		self._instance.InertiaXkgm2 = value

	@property
	def inertia_ykgm2(self) -> float | None:
	...
	def inertia_ykgm2(self, value: float | None):
		self._instance.InertiaYkgm2 = value

	@property
	def inertia_zkgm2(self) -> float | None:
	...
	def inertia_zkgm2(self, value: float | None):
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, RmiSetPayloadParameters):
			NotImplemented
